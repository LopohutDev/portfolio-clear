  ...
  return (
    <section id="contact" className="py-24 bg-gray-900">
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <FadeIn delay={0.1} className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
          <a
        ...
        {/* Social links */}
        <FadeIn delay={0.2} className="flex items-center justify-center gap-8 mb-20">
          <a
